...
- recommencer une génération pour gagner de l’Héritage permanent.
...
Le développement manuel reste utile grâce à plusieurs améliorations qui ajoutent progressivement une part de la production automatique à chaque clic. Les gains d’Héritage progressent logarithmiquement selon les crédits obtenus pendant la génération, puis son bonus permanent utilise un rendement décroissant : `×(1 + 0,20 × √Héritage)`.
