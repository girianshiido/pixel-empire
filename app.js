...
const archiveBranches = [
  ...
  {id:"technical",name:"Technique",icon:"⚙️",nodes:[
    ...
    {id:"archive_production_memory",name:"Mémoire de production",cost:35,kind:"queueSlots",value:1,description:"Ajoute une place permanente dans la file"}
  ]}
];
...
const initialState = () => ({
  ...
  owned:initialOwned(),upgrades:[],genreProgress:initialGenreProgress(),catalog:[],franchises:[],activeProject:null,projectQueue:[],
